...
Okezone.prototype.getTitle = function($) {
  ...
  title = (_.isEmpty(title)) ? $('div.title-detail h1').text() : title
...
Okezone.prototype.getDate = function($) {
  ...
  $('div.title-detail span').find('b').remove()
  ...
  date = (_.isEmpty(date)) ? $('div.title-detail span').text() : date
...
Okezone.prototype.getContent = function($) {
  var arr = [
    'div#contentx',
    'div.bg-euro-body-news-hnews-content-textisi',
    'div.title-detail div.ctn-desc'
  ]
  ...
  content = (_.isEmpty(content)) ? $('div.title-detail div.ctn-desc').text() : content
