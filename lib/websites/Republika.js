...
Republika.prototype.getTitle = function($) {
  ...
  title = (_.isEmpty(title)) ? $('div.h5.global-detail').text() : title
  title = (_.isEmpty(title)) ? $('meta[name="title"]').attr('content') : title
...
Republika.prototype.getDate = function($) {
  ...
  date = (_.isEmpty(date)) ? $('div.date-detail.global-detail').text() : date
...
Republika.prototype.getContent = function($) {
  var arr = [
    'div.detail-berita div.content-detail',
    'div.teaser-pic p',
    'div.teaser.global-detail p'
  ]
  ...
  content = (_.isEmpty(content)) ? $('div.teaser.global-detail p').text() : content
