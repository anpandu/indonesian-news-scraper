  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-16T09:10:56.000Z'))
      ...
      .then(function (result) {
        ...
        assert(_.isEqual(result['date'], '2016-02-16T09:20:00.000Z'))
      ...
      .then(function (result) {
        ...
        assert(_.isEqual(result['date'], '2016-02-16T09:09:27.000Z'))
        ...
        assert(_.isEqual(result['content'], 'Penyanyi Taylor Swift (kanan) memeluk Selena Gomez saat berpose di karpet merah Grammy Awards ke-58 di Staples Center, Los Angeles, Senin (15/2). (REUTERS / Danny Moloshok) Selena Gomez dan Taylor Swift berpose untuk fotografer saat tiba di karpet merah Grammy Awards ke-58 di Staples Center, Los Angeles, Senin (15/2). (REUTERS / Danny Moloshok) Selena Gomez (kiri) tampak berbincang dengan sahabatnya yang juga penyanyi, Taylor Swift, saat menghadari ajang bergengsi Grammy Awards ke-58 di Staples Center, Los Angeles, Senin (15/2). (REUTERS / Danny Moloshok) Keakraban Selena Gomez dan Taylor Swift saat berpose di karpet merah Grammy Awards ke-58 di Staples Center, Los Angeles, Senin (15/2). (REUTERS / Danny Moloshok) Selena Gomez dan Taylor Swift saling memeluk saat berpose di karpet merah Grammy Awards ke-58 di Staples Center, Los Angeles, Senin (15/2). (REUTERS / Danny Moloshok)'))
        assert(_.isEqual(result['source'], 'Liputan6'))
      })
  })
