  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        assert(result['date'] == '2015-11-05T08:07:00.000Z')
