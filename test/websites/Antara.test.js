  ...
  it('getURLsFromMainPage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        assert(result[0] == 'http://www.antaranews.com/berita/527615/29-penerbangan-bandara-internasional-lombok-dibatalkan')
        assert(result[1] == 'http://www.antaranews.com/berita/527614/mengatasi-kebuntuan-riset-pangan-indonesia')
        assert(result[2] == 'http://www.antaranews.com/berita/527613/indonesia-akan-terima-kunjungan-presiden-italia')
      })
  })
