  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-23T14:49:30+07:00'))
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-23T14:39:42+07:00'))
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-23T08:06:00.000Z'))
