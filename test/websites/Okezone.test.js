  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        assert(_.isEqual(result['content'], "JAKARTA - Memiliki segudang kesibukan di dunia entertainment, tidak membuat aktor sekaligus komedian, Indra Birowo lupa dengan sang istri. Pria berusia 44 tahun ini bahkan menyatakan bahwa ia selalu mencoba peka terhadap situasi saat sedang bersama sang istri untuk tetap romantis. Hal-hal sederhana selalu ia tunjukkan kepada sang istri demi menjaga keromantisan hubungan rumah tangganya. Bahkan Indra mengaku sering membelikan sang istri bunga untuk membuat hubungan keduanya semakin mesra. \"Ya harus bisa lebih peka terhadap situasi saja sih, kalau misalnya lama berdua enggak ngobrol misalnya, ya sekali waktu malam bawa bunga, atau ajak pergi dinner atau nonton,\" kata Indra Birowo kepada Okezone, Jumat (17/2/2017). \"Kadang dengan hal yang simple, dia belanja dan aku jemput. Yang dia pikir aku enggak akan jemput. Ya hal-hal simple, tapi kadang kalau di dalam keseharian jadi penting,\" sambungnya. Ulang tahun pernikahan bagi Indra Birowo merupakan sebuah momen istrimewa yang hampir tidak pernah luput dari pandangannya. Ia bahkan mengaku bingung untuk memberikan kejutan apalagi untuk sang istri, lantaran setiap tahunnya ia selalu memberikan hal yang istimewa kepada ibu dari kedua anaknya tersebut. \"Tanggal 21 besok kan ulang tahun pernikahan, tapi enggak ada rencana apa-apa. Tapi aku sih ingin membuat sesuatu itu, tapi apa masih belum tahu,\" tuturnya. \"Enggak tahunya karena setiap tahun selalu begitu, jadi bingung mau buat sesuatu yang beda. Ya biasanya sih pasti ada sesuatu yang dibawa, apakah hadiah, ya gitu-gitulah,\" tandasnya. (FHM) 0 Komentar"))
        assert(_.isEqual(result['source'], 'Okezone'))
      })
  })
