  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        assert(result['date'] == 'Kamis 5 November 2015 - 15:56 ')
