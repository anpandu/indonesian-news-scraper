  ...
  it('getURLsFromMainPage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        assert(result[0] == 'http://nasional.tempo.co/read/news/2015/11/05/058716101/abu-gunung-barujari-ganggu-37-penerbangan-di-bandara-juanda')
        assert(result[1] == 'http://seleb.tempo.co/read/news/2015/11/05/219716100/sebelum-meninggal-misye-arsita-dirawat-di-kediri')
        assert(result[2] == 'http://dunia.tempo.co/read/news/2015/11/05/116716099/pasca-merger-produsen-keju-ini-menutup-tujuh-pabriknya')
      })
  })
