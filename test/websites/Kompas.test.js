  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-23T09:37:00.000Z'))
        assert(_.isEqual(result['img'], 'http://assets.kompas.com/data/photo/2016/02/16/1703186samsul-arif-purwaka-yudi-dok-persibp.jpg'))
        assert(_.isEqual(result['content'], 'Penyerang anyar Persib Bandung, Samsul Arif, bertekad memberikan penampilan terbaiknya saat melawan Arema Cronus pada pertandingan terakhir Bali Island Cup di Stadion Kapten I Wayan Dipta, Gianyar, Bali, Selasa (23/2/2016) malam nanti. Samsul memilih meninggalkan Arema untuk memperkuat Persib pada turnamen Bali Island Cup. Penyerang berusia 31 tahun itu pun menandai debut gemilang bersama Persib seusai mencetak gol ke gawang PSS Sleman pada pertandingan perdana Bali Island Cup. Persib kemungkinan besar mengandalkan Samsul Arif saat melawan Arema. Selain penentuan gelar juara, laga ini juga menjadi pertandingan emosional bagi Samsul. "Hidup saya sudah di Persib dan akan berjuang buat tim ini. Bagi saya, setiap pertandingan tersebut harus kerja keras dan memberikan kemenangan buat tim. Saya merasa tidak ada beban dalam bertanding. Semua sama saja. Kami harus menang," kata Samsul seperti dikutip dari situs resmi Persib, Selasa (23/2/2016). Terkait kekuatan mantan timnya, Samsul mengaku tidak terlalu memusingkannya. Dia akan bermain sesuai dengan instruksi pelatih Dejan Antonic. Sebab, sejauh ini, Samsul belum mengetahui bagaimana karekter dan gaya bermain pelatih Arema, Milomir Seslija. "Saya kalau tidak salah baru lima kali berlatih bersama coach Milo (Milomir Seslija). Yang pasti, kami ingin menang pada pertandingan nanti dan kami ingin juara," ujarnya.'))
        assert(_.isEqual(result['source'], 'Kompas'))
      })
      .then(function () {
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-23T09:52:00.000Z'))
        assert(_.isEqual(result['img'], 'http://assets.kompas.com/data/photo/2015/12/07/0322335Wuling-saleh-husinp.jpg'))
        assert(_.isEqual(result['content'], 'Tahun depan, dua produsen otomotif asal China, SAIC-GM-Wuling dan Sokonindo Indonesia (SI) mulai meramaikan industri otomotif Indonesia. Bahkan, Wuling berinvestasi Rp 9,2 triliun membangun pabrik di atas lahan seluas 30 hektar. Menanggapi kondisi itu, Ketua Umum Gaikindo periode 2016-2019 Johannes Nangoi, mengatakan, semakin banyak merek baru yang masuk, semakin bagus. Sebab, Indonesia dinilai sebagai pasar potensial. "Masyarakat menjadi punya banyak pilihan dalam membeli mobil. Apalagi mereka membangun pabrik dan harusnya ditiru oleh produsen lain yang belum punya pabrik di Indonesia," ungkap Nangoi saat berbincang dengan KompasOtomotif usai acara rapat umum anggota Gaikindo 2016, di hotel Pullman, Thamrin, Jakarta Pusat, Selasa (23/2/2016). Menurut Nangoi, produsen otomotif baru yang mendirikan pabrik di Indonesia itu sangat bagus. Sebab, selain menguntungkan bagi pabrikan itu sendiri, untung lainnya bisa menyerap tenaga kerja lokal. "Otomatis kalau membangun pabrik, mereka membutuhkan tenaga kerja lokal. Itu untungnya bagi masyarakat Indonesia," kata pria yang menjabat sebagai Presiden Direktur PT Isuzu Astra Motor Indonesia (IAMI) ini. Nangoi melanjutkan, sukses atau tidaknya merek itu di Indonesia ditentukan oleh konsumen. Sehingga, masing-masing produsen harus memiliki cara bagaimana menggaet konsumen Indonesia membeli produknya. "Persaingan memang cukup ketat, oleh karena itu masing-masing produsen harus memiliki cara bagaimana bisa menarik minat masyarakat Indonesia untuk membeli produknya. Itu pekerjaan yang harus dilakukan oleh merek baru," ujar Nangoi.'))
        assert(_.isEqual(result['source'], 'Kompas'))
      })
  })
