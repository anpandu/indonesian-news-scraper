  ...
  it('getDataFromSinglePage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        ...
        // assert(_.isEqual(result['date'], '2016-02-14T02:15:00.000Z'))
