  ...
  it('getURLsFromMainPage()', function () {
    return Promise.resolve()
      ...
      .then(function (result) {
        assert(result[0] == 'http://www.kapanlagi.com/showbiz/asian-star/drama-adaptasi-webtoon-cheese-in-trap-rilis-teaser-perdana-eeddf5.html')
        assert(result[1] == 'http://www.kapanlagi.com/showbiz/bollywood/berantem-di-bar-shahrukh-khan-pamer-luka-memar-di-lengannya-bb4ee8.html')
        assert(result[2] == 'http://www.kapanlagi.com/showbiz/film/indonesia/video-si-kocak-mamet-aadc-tirukan-goyangan-penyanyi-dangdut-e1056a.html')
      })
  })
